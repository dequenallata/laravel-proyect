<h3>{{$Modo=='crear' ? 'Agregar Empleado':'Modificar Empleado'}}</h3>
...
<input type="file" class="form-control {{$errors->has('Foto')?' is-invalid':''}}" name="Foto" id="Foto" value="{{isset($empleado->Foto) ? $empleado->Foto:''}}">
<br/>
